...
exports.scrollIt = exports.preloadImages = exports.preloadFonts = exports.lerp = exports.getMousePos = exports.calcWinsize = void 0;
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/contentPage.js":[function(require,module,exports) {
"use strict";
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var ContentPage = /*#__PURE__*/_createClass(function ContentPage(el) {
...
},{}],"js/menuItem.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../node_modules/gsap/index.js","./contentPage":"js/contentPage.js"}],"js/menuController.js":[function(require,module,exports) {
"use strict";
...
var MenuController = /*#__PURE__*/function () {
  function MenuController(el) {
    ...
    this.DOM.galleries = _toConsumableArray(document.querySelectorAll('.bg-gallery-wrap > .bg-gallery'));
    // Content DOM
    this.DOM.pagePreview = document.querySelector('.page--preview');
    this.DOM.content = _toConsumableArray(this.DOM.pagePreview.querySelectorAll('.content'));
      ...
      try {
        var _loop = function _loop() {
          ...
          item.DOM.el.addEventListener('click', function (ev) {
            ...
            _this2.toggleMenuItems(item, direction);
...
},{"./utils":"js/utils.js","gsap":"../node_modules/gsap/index.js","./menuItem":"js/menuItem.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
Promise.all([(0, _utils.preloadImages)('.gallery__figure-img'), (0, _utils.preloadFonts)('yuz0mhb')]).then(function () {
  ...
  new _menuController.default(document.querySelector('.menu'));
...
},{"./utils":"js/utils.js","./cursor":"js/cursor.js","./menuController":"js/menuController.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
